...
# spatial_file_path = "/home/frank/Documents/GAT-ID/simulation/ST/seqFISH+_OBcortex_cellType_100.h5ad"
# celltype_key = 'cell_type'
# output_file_path = "/home/frank/Documents/GAT-ID/simulation/results"
file_name = 'Tangram_' + \
            spatial_file_path.split('/')[-1].split('.h')[0] + "_" + sce + "_results.csv"
...
celltype_density.to_csv(res_file_path)
